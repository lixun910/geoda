...
void Basemap::SetupMapType(int map_type)
{
    ...
    if (mapType == 1) {
        ...
        basemapUrl = "https://a.basemaps.cartocdn.com/dark_all/";
        urlSuffix = ".png";
        if (scale_factor == 2.0) urlSuffix = "@2x.png";
        imageSuffix = ".png";
        
    } else if (mapType == 3) {
        basemapUrl = "https://a.basemaps.cartocdn.com/light_nolabels/";
        urlSuffix = ".png";
        if (scale_factor == 2.0) urlSuffix = "@2x.png";
        imageSuffix = ".png";
    } else if (mapType == 4) {
        basemapUrl = "https://a.basemaps.cartocdn.com/dark_nolabels/";
        urlSuffix = ".png";
        if (scale_factor == 2.0) urlSuffix = "@2x.png";
        imageSuffix = ".png";
    } else if (mapType == 5) {
